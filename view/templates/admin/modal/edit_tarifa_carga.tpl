    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-plus'></i> Editar tarifa del barco <b id="tarifa_title"></b></h4>
            </div>
                ...
                <form class="form-horizontal" method="post" id="editar_tarifa" name="editar_tarifa">
                    ...
                    <div class="form-group hide">
                        <div class="col-sm-8">
                            ...
                            <input type="number" class="form-control" id="barco_tarifa" name="barco_tarifa"/>
                        </div>
                    </div>
